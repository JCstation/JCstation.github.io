...
function webViewerInitialized() {
  var appConfig = PDFViewerApplication.appConfig;
  PDFViewerApplication.pdfLinkService.externalLinkTarget = _pdfjsLib.LinkTarget.BLANK;
  var file;
  var toolbar;
  var sidebar;
  var textSearch;
  ...
  toolbar = 'toolbar' in params ? params.toolbar : true;
  sidebar = 'sidebar' in params ? params.sidebar : true;
  ...
  if (toolbar == 'true') {
    document.getElementById('toolbarContainer').removeAttribute('hidden');
    if (sidebar == 'false') {
      appConfig.sidebar.toggleButton.setAttribute('hidden', 'true');
    }
    if (textSearch == 'false') {
      appConfig.toolbar.viewFind.setAttribute('hidden', 'true');
    }
    if (fullscreen == 'false') {
  ...
  if (enableLinks == 'false') {
    PDFViewerApplication.pdfLinkService.externalLinkEnabled = false;
  }
